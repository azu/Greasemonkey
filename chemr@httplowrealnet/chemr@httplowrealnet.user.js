...
(function () {
    with (D()) {
        ...
        http.post = function (url, data) {
            return http({method:"post", url:url, data:data, headers:{"Content-Type":"application/x-www-form-urlencoded"}})
        };
        ...
        function Chemr() {
            return Chemr.instance || this.init.apply(this, arguments)
        }
...
//				});
            ...
            keypress : function (e) {
                ...
                var handler = {
                    ...
                    'C-c' : function () {
                        ...
                        if (option) {
                            GM_setClipboard(option.value);
                            GM_notification(option.value + "をコピー", option.title);
                        }
                    },
                    'C-l' : function () {
                        self.html.input.focus();
            ...
            search : function (query) {
                var self = this;
                var cnv = self.functions.beforeSearch || function (a) {
                ...
                // scoring and sort
                var regex = new RegExp('(' + query.replace(/\s+/, ' ').split('').map(
                        function (c) {
